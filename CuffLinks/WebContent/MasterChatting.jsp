...
<script
	src="https://cdn.jsdelivr.net/npm/semantic-ui@2.4.0/dist/semantic.min.js"></script>
</head>
<body>
	<div class="ui text container">
		...
		<div class="ui action input">
			...
			<input id="msg" type="text" placeholder="메시지를 입력해주세요">
			<button class="ui button">입력</button>
		</div>
	</div>
	<script>
		var socket = new WebSocket('ws://192.168.0.59:8080/WebSocketServer')
		var data = []
