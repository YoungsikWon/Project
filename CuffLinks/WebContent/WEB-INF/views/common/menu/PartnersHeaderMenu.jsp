...
<div class="ui inverted segment" style="margin-top: 0px; padding-top: 3px; padding-bottom: 3px; margin-bottom: 0px;">
   <div class="ui container">
      <a href="../partners/partnersMyWishket?s_email=<%= email %>"><img src="/image/logo.jpg" class="ui image tiny" alt="" style="float: left; margin-right: 10px" /></a>
...
%>
         ...
         <div id = "menu_list" class="ui dropdown" style="width: 150px;">
            ...
            <div  class="menu">
               ...
               <div class="item" onclick="location.href='../partners/partnersMyprofileMain?s_email=<%= email %>'"><i class="user icon"></i>내 프로필 보기</div>
...
<div class="submenu" style="border-bottom: groove thin;">
   <div class="ui container">
      <div class="ui secondary menu">
         ...
         <a href="../partners/partnersInterestProject?s_email=<%= email %>" id="partnersInteresProject" class="partnersInteresProject item"> 관심 프로젝트  </a> 
         <a href="../partners/partnersSupportHistory?s_email=<%= email %>" id="partnersSupportHistory" class="partnersSupportHistory item"> 지원 내역 </a> 
         <a href="../partners/partnersProject_ing?s_email=<%= email %>" id="partnersProject_ing" class="partnersProject_ing item"> 진행 중인 프로젝트 </a>
         <a href="../partners/partnersCompleteProject?s_email=<%= email %>" id="partnersCompleteProject" class="partnersCompleteProject item"> 완료한 프로젝트 </a>
      </div>
   </div>
</div>
