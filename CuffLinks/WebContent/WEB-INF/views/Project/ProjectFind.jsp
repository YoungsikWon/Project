...
<body>
	...
	<div class="ui container raised segment content"
		...
		<div class="ui container">
			...
			<div class="ui pagination menu">
				<a class="active item" href="javascript:cateHandler(categoryList(),1)">1 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),2)">2 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),3)">3 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),4)">4 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),5)">5 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),6)">6 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),7)">7 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),8)">8 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),9)">9 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),10)">10 </a>
				<a class="active item" href="javascript:cateHandler(categoryList(),11)">11</a>
				<a class="item" href="javascript:cateHandler(categoryList(),12)">12 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),13)">13 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),14)">14 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),15)">15 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),16)">16 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),17)">17 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),18)">18 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),19)">19 </a>
				<a class="item" href="javascript:cateHandler(categoryList(),20)">20 </a>
			</div>
		</div>
	</div>
	<!----------------------------------------------------------------------- footer content 시작 -->
	...
	<script type="text/javascript">
		...
		//category에 대한 처리 함수
		function cateHandler(categoryList, pageNum) {
			$.ajax({
				...
				success : function(data) {
					$('#body').html('')
					for (d of data) {
						projectAppendHTML(d.PRO_NO, d.PRO_NAME, d.PRO_PRICE, d.PRO_PERIOD, d.PRO_START, d.PRO_END, d.PRO_SKILL, d.PRO_CONTENTS) }
				}
			});
		}
	
		//html로 되어있는 project 넣기
		function projectAppendHTML(pro_no, pro_name, pro_price, pro_period, pro_start, pro_end, pro_skill, pro_contents) {
			$('#body').append(`<div class="ui raised segment" style="padding: 20px;">
						<div class="column" style="text-align: left;">
						<h3>
							<a href="./View?` + pro_no + `=">` + pro_name + `</a>
						</h3>
