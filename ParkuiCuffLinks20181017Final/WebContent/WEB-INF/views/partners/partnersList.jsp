					...
					<div class="twelve wide column " style="border-right: 1px solid #dedede; vertical-align: middle;padding: 20px; width: 60%;">
						...
						<div class="item">
						    <div class="ui small circular rotate reveal image"style="width: 150px;height: 150px;">
					         <img src="/image/wishket.png" class="visible content"style="width: 150px;height: 150px;">
					         <img src="<%=path %><%=intro.get(0).get("P_IMG") %>" class="hidden content"style="width: 150px;height: 150px;">    
					       </div>
					...
					<div class="four wide column " style="padding: 10px;padding-left: 30px;">
						<div class="ui middle aligned divided list" style="border:0px">
							 <div class="item" style="padding-top: 20px;padding-bottom: 20px;">
								<span class="content" style="padding: 0px"><span id="p_ratingAvg" class="ui large star rating"></span><span class='avg_allpro'><%=grade.get(0).get("AVG_ALLPRO")%></span>/</span>
								<span class="right floated content" style="padding: 0px; margin: 0px">평가 <%=grade.get(0).get("EVAL_COUNT") %>개</span>
							</div>
							<div class="item" style="padding-top: 20px;padding-bottom: 20px;">
