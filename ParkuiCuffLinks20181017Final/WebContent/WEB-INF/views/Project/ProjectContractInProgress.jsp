...
<body>
	...
	<div class="ui container">
		...
		<div class="ui two column grid container"
			style="min-height: 670px; height: auto;">
			<div class="ui column"
				...
				<div class="ui fluid vertical menu" style="padding-right: 0px">
					<a href="/project/projectContractInProgress"
						class="teal item active">
						<font style="vertical-align: inherit;"> 프로젝트 진행 중 </font>
					</a>
				</div>
				<div class="ui fluid vertical menu"
					style="padding-top: 10px; padding-bottom: 10px; padding-left: 15px; padding-right: 15px; background-color: #E0F8E6;">
					<div style="padding-bottom: 5px;">
						<b>
							<h10>커프링크 사업자 등록 정보</h10>
						</b>
					</div>
				...
				<div class="ui fluid vertical menu"
					...
					<b>
						<font style="vertical-align: inherit;">커프링크 대금보호계좌 정보</font>
					</b>
					<br>
					<br>
					<h11>은행명 : 기업은행<br>
			...
			<div class="ui column"
				style="padding-left: 5px; padding-top: 0px; padding-bottom: 0px; width: 80%;">
				<div class="ui container"
					style="padding: 20px; padding-bottom: 20px; left: 5px; border: 1px solid #dedede;">
					<h3 style="text-align: left">프로젝트 진행 중</h3>
					<h5 style="text-align: left">현재 진행 중인 프로젝트를 확인할 수 있습니다</h5>
				</div>
				<div style="height: 10px;"></div>
				<div
					style="padding-top: 20px; padding-bottom: 20px; padding-left: 15px; padding-right: 15px; border: 1px solid #dedede;">
					<div style="height: 10px;"></div>
					<div class="ui two column grid container"
						...
						<div class="column" style="width: 10%; padding: 20px">
							<img class="ui medium circular image" style="width: 40px;"
								src="../../image/process-guide-success.png">
						</div>
						<div class="column"
							style="width: 90%; text-align: left; padding-left: 5px">
							1. 현재 진행 중인 프로젝트 목록입니다.
							<br>
							2. 프로젝트는 대금 결제 후에 진행됩니다.
							<br>
							3. 커프링크은
					...
					<div
						style="text-align: left; padding-left: 10px; padding-top: 20px; padding-bottom: 0px"></div>
					<%
						if (getState.size() <= 0) {
					%>
					<div
						style="text-align: left; padding-left: 10px; padding-top: 20px; padding-bottom: 0px; min-height: 380px; border: 1px solid #dedede;">프로젝트
						진행 내역이 없습니다.</div>
					<%
						} else {
					%>
					...
					<div class="ui column segment"
						...
						<div class="ui blue left attached label">
							>>진행<<
							</a>
						</div>
