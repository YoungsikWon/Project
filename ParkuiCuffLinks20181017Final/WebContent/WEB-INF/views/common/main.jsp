...
<body>
		...
		<div class="ui container">
			<div class="ui secondary pointing menu" style="margin-bottom: 50px;">
				...
				<a href="/auth/login" id="projectRegister"
					class="projectRegister item">프로젝트 등록 </a>
				<a href="../project/page?pagenum=1" id="projectFind"
					class="projectFind item">프로젝트 찾기 </a>
				<a href="../partners/partnersList" id="partnersList"
		...
		<div class="ui segments">
			<div class="ui horizontal segments">
				...
				<div class="ui segment">
					<h5>등록된 프로젝트</h5>
					<h2>
						<span class="counter">14,234</span>
					</h2>
					개
				</div>
				<div class="ui segment">
					...
					<h2>
						<span>$</span>
						<span class="counter">142,030,018,631</span>
					</h2>
					원
				</div>
				<div class="ui segment">
					<h5>개발회사 프리랜서</h5>
					<h2>
						<span class="counter">54,453</span>
					</h2>
					명
				</div>
	...
	<div style="background-color: rgb(243, 244, 247);">
		<div class="ui container"
			style="padding-top: 5px; padding-bottom: 5px; font-size: 1.5em; text-align: center; background-color: #A9D0F5; border-bottom: 1px solid #000;">
		...
		<div class="ui container" style="padding-top: 20px;">
			<div class="ui three column grid">
				...
				<div class="column">
					<div class="ui segment">
						<a href="#" class="title"><%=main_pro.get(i).get("PRO_NAME")%></a>
						<p></p>
						<span>
							<i class="won sign icon"></i>
							<%=main_pro.get(i).get("PRO_PRICE")%>
						</span>
						<span class="middle">
							<i class="clock outline icon"></i>
							<%=main_pro.get(i).get("PRO_PERIOD")%>
						</span>
						<span>
							<i class="pencil alternate icon"></i>
							<%=main_pro.get(i).get("PRO_SKILL")%>
						</span>
						<p></p>
						<p class="content">
	...
	<div class="ui container"
		style="position: relative; padding-top: 5px; padding-bottom: 5px; font-size: 1.5em; text-align: center; background-color: #A9D0F5; border-bottom: 1px solid #000;">
		<img src="../image/logo.png" alt="" style="margin-right: 10px;" />
		클라이언트 의뢰 주변 검색
		<div class="ui mini search"
			style="position: absolute; top: 2px; right: 0; float: right;">
			<div class="ui icon input">
				<div class="ui search" style="">
					<input class="prompt" id="MapSearch" type="text"
						placeholder="Search countries..." style="height: 20px;">
	...
	<div class="ui container"
		style="padding-top: 0px; text-align: center; height: 480px; background-color: #dedede;">
		<div>
