...
<div class="ui inverted segment"
	...
	<div class="ui container">
		<a href="../clients/ClientMyCufflink">
			<img src="/image/logo.jpg" class="ui image tiny" alt=""
				style="float: left; margin-right: 10px" />
		</a>
		<div class="ui inverted secondary pointing menu"
			style="margin-top: 0px;">
			<a href="../clients/projectRegisterDetail" id="projectRegister"
			...
			<div class="right mini menu">
				<div class="right menu"
					...
					<button class="ui primary button" style="margin-right: 10px;"
						onclick="location.href='/auth/join'">회원가입</button>
			...
			<form id="f_logout">
				<div id="menu_list" class="ui dropdown" style="width: 150px;">
					...
					<div class="menu">
						<div class="item"
							onclick="location.href='../clients/ClientMyCufflink'">
							<i class="home icon"></i>
							마이 커프링크
						</div>
...
<div class="submenu" style="border-bottom: groove thin;">
	<div class="ui container">
		<div class="ui secondary menu">
			<!-- ************************* 메뉴버튼클릭시 활성화효과 -->
			<a href="../project/projectRecruiting" id="projectRecruiting"
				class="projectRecruiting teal item"> 지원자 모집중 </a>
			<a href="../project/projectContractInProgress"
				id="projectContractInProgress"
				class="projectContractInProgress teal item"> 진행중인 프로젝트 </a>
				<!-- 수정 20181017 시작 -->
			<a href="../project/projectCompletedContract" id="projectReviewContract"
				class="projectReviewContract teal item"> 종료된 프로젝트 </a>
				<!-- 수정 20181017 끝 -->
			<!-- ************************* 메뉴버튼클릭시 활성화효과 -->
		</div>
	</div>
