								...
								<div class="column container" style="padding: 10px; width: 75%; ">
									<div class="ui two column grid" class="item" style="float:right;">
										<div class="column" style="width:auto;">
											<div class="ui primary button" onclick="location.href='/PartnersInfo'">등록완료</div>
										</div>
										<div class="column" style="width:auto;">
											<div class="ui button" onclick="location.href='/PartnersInfo'">취소</div>
										</div>
									</div>
								</div>
							</div>
